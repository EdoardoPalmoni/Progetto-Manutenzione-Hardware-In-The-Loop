...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /**/
  LL_GPIO_ResetOutputPin(USB_FS_PWR_EN_GPIO_Port, USB_FS_PWR_EN_Pin);
  ...
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(USB_FS_PWR_EN_GPIO_Port, &GPIO_InitStruct);

  /**/
  GPIO_InitStruct.Pin = USB_FS_VBUS_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(USB_FS_VBUS_GPIO_Port, &GPIO_InitStruct);
  ...
  LL_GPIO_Init(USB_FS_ID_GPIO_Port, &GPIO_InitStruct);
  ...
  /**/
  LL_GPIO_SetPinPull(USB_FS_OVCR_GPIO_Port, USB_FS_OVCR_Pin, LL_GPIO_PULL_NO);

  /**/
  LL_GPIO_SetPinMode(USB_FS_OVCR_GPIO_Port, USB_FS_OVCR_Pin, LL_GPIO_MODE_INPUT);
