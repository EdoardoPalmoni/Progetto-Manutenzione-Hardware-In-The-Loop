 ...
 *
 * PIL generated interface for code: "Algorithm_to_deploy"
 *
 */
...
/* interface data */
real32_T i_prdotms[3];

/* interface data */
real32_T i_prddotms2[3];

/* interface data */
real32_T i_yawrrad;

/* interface data */
real32_T i_yawrdotrads;

/* interface data */
real32_T i_yawrddotrads2;
...
/* interface data */
MdlrefDW_Algorithm_to_deploy_T Algorithm_to_deploy_MdlrefDW;

/* interface (pointer) data */
RT_MODEL_Algorithm_to_deploy_T * RTModel_ptr =
  &(Algorithm_to_deploy_MdlrefDW.rtm);
static XILIOData xil_fcnid0_task1_output_u[11];
...
XIL_INTERFACE_ERROR_CODE xilInitialize(uint32_T xilFcnId)
{
  ...
  {
    {
      ...
      for (elementIdx_0 = 0; elementIdx_0 < 6; elementIdx_0++) {
        o_u[elementIdx_0] = 0;
      }                                /* for */
    }
  }
  ...
  if (xilFcnId == 0) {
    ...
    Algorithm_to_deploy_initialize(rt_errorStatus, RTModel_ptr);
...
XIL_INTERFACE_ERROR_CODE xilSystemInitialize(uint32_T xilFcnId)
{
  ...
  /* Single In-the-Loop Component */
  if (xilFcnId == 0) {
    Algorithm_to_deploy_Init(&(Algorithm_to_deploy_MdlrefDW.rtdw));
  } else {
    errorCode = XIL_INTERFACE_UNKNOWN_FCNID;
  }
   ...
   case XIL_OUTPUT_COMMAND:
    {
      ...
      if (!initComplete) {
        ...
        {
          void * dataAddress = (void *) &(i_pdotms[0]);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 3 * sizeof
            (real32_T);
          xil_fcnid0_task1_output_u[tableIdx++].address = (MemUnit_T *)
            dataAddress;
        ...
        {
          void * dataAddress = (void *) &(i_omegarads[0]);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 3 * sizeof
            (real32_T);
          xil_fcnid0_task1_output_u[tableIdx++].address = (MemUnit_T *)
            dataAddress;
        ...
        {
          void * dataAddress = (void *) &(i_R[0]);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 9 * sizeof
            (real32_T);
          xil_fcnid0_task1_output_u[tableIdx++].address = (MemUnit_T *)
            dataAddress;
        }
        ...
        {
          void * dataAddress = (void *) &(i_prdotms[0]);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 3 * sizeof
            (real32_T);
          xil_fcnid0_task1_output_u[tableIdx++].address = (MemUnit_T *)
            dataAddress;
        ...
        {
          void * dataAddress = (void *) &(i_prddotms2[0]);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 3 * sizeof
            (real32_T);
          xil_fcnid0_task1_output_u[tableIdx++].address = (MemUnit_T *)
            dataAddress;
        ...
        {
          void * dataAddress = (void *) &(i_yawrrad);
        ...
        {
          void * dataAddress = (void *) &(i_yawrdotrads);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 1 * sizeof
            (real32_T);
          xil_fcnid0_task1_output_u[tableIdx++].address = (MemUnit_T *)
            dataAddress;
        ...
        {
          void * dataAddress = (void *) &(i_yawrddotrads2);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 1 * sizeof
            (real32_T);
          xil_fcnid0_task1_output_u[tableIdx++].address = (MemUnit_T *)
            dataAddress;
...
XIL_INTERFACE_ERROR_CODE xilOutput(uint32_T xilFcnId, uint32_T xilTID)
{
  ...
  switch (xilTID) {
   case 1:
    /* Call all Set class methods */
    Algorithm_to_deploy(i_pm, i_pdotms, i_omegarads, i_R, i_prm, i_prdotms,
                        i_prddotms2, &(i_yawrrad), &(i_yawrdotrads),
                        &(i_yawrddotrads2), o_u,
                        &(Algorithm_to_deploy_MdlrefDW.rtdw));
   ...
   case XIL_SYSTEM_INITIALIZE_COMMAND:
    {
      ...
      if (!initComplete) {
        ...
        {
          void * dataAddress = (void *) &(o_u[0]);
          xil_fcnid0_system_initialize_y[tableIdx].memUnitLength = 6 * sizeof
            (real32_T);
