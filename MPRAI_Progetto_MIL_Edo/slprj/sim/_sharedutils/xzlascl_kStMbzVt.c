#include "rtwtypes.h"
#include "xzlascl_kStMbzVt.h"
#include "mwmathutil.h"
#include <emmintrin.h>
void xzlascl_kStMbzVt ( real_T cfrom_prot , real_T cto_prot , int32_T m_prot
, real_T A_prot [ 3 ] , int32_T iA0_prot ) { __m128d tmp_prot ; real_T
